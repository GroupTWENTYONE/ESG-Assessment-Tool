...
E_OUTPUT_FILE = os.path.join(current_script_dir, "../../../ML/ml_ready_data/ml_ready_e.json")
S_OUTPUT_FILE = os.path.join(current_script_dir, "../../../ML/ml_ready_data/ml_ready_s.json")
G_OUTPUT_FILE = os.path.join(current_script_dir, "../../../ML/ml_ready_data/ml_ready_g.json")
